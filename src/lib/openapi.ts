/**
 * OpenAPI 3.1 specification for Aurora / Semantic SEO Synthesizer.
 *
...
export const spec: Record<string, unknown> = {
  openapi: '3.1.0',
  info: {
    title: 'Semantic SEO Synthesizer API',
    version: '1.0.0',
    description: `
**Semantic SEO Synthesizer** is an AI-powered SEO content platform for generating, managing, and publishing blog posts, dictionaries, and brand content.
...
`,
    contact: { name: 'Semantic SEO Synthesizer', url: 'https://openseo.ai' },
  },
